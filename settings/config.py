...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='fd6a9cfbb06355', description="Username for SMTP server")
    smtp_password: str = Field(default='1f67bf0a1eabf6', description="Password for SMTP server")
